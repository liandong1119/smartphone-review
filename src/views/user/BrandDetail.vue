            ...
            <div v-if="brand" class="brand-header">
                <div class="brand-info">
                    ...
                    <div class="brand-title">
                        <h1>{{ brand.name }} <span class="brand-name-en" v-if="brand.nameEn">({{ brand.nameEn }})</span>
                        </h1>
            ...
            <div v-else>
                ...
                <div v-else class="posts-list">
                    <div v-for="post in posts" :key="post.id" class="post-card card-hover" @click="viewPost(post.id)">
                        <div class="post-image" v-if="post.fileList != null">
                            <img :src="post.fileList[0]" :alt="post.title"/>
                        </div>
